...
label_encoder_path = os.path.join(PREPROCESS_DIR, "label_encoder.joblib")
onehot_encoder_path = os.path.join(PREPROCESS_DIR, "onehot_encoder.joblib")
scaler_path = os.path.join(PREPROCESS_DIR, "scaler.joblib")
columns_info_path = os.path.join(PREPROCESS_DIR, "columns_info.joblib")
